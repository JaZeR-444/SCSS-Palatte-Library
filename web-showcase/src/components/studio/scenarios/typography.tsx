...
export function TypographyScenario() {
  ...
  const tests = [
    ...
    {
      name: "Brand Primary on Background",
      textVar: "--ui-color-1",
      bgVar: "--ui-color-3",
      type: "large",
    },
    {
      name: "Accent Secondary on Background",
      textVar: "--ui-color-2",
      bgVar: "--ui-color-3",
      type: "large",
    },
    {
      name: "Success State on Surface",
      textVar: "--ui-color-8",
      bgVar: "--ui-color-4",
      type: "large",
    },
    {
      name: "Danger State on Surface",
      textVar: "--ui-color-10",
      bgVar: "--ui-color-4",
      type: "large",
    },
  ...
  const getCompliance = (ratio: number, type: string) => {
    ...
    if (ratio >= minAA)
      return {
        grade: "AA Pass",
        style: "text-indigo-500 bg-indigo-500/10 border-indigo-500/20",
        icon: Check,
      };
    return {
      grade: "Fail",
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h3
              ...
              style={{ color: roleMapping["--ui-color-2"] }}
            >
              Heading Level 3
            </h3>
          </div>
          ...
          <p
            ...
            style={{ color: roleMapping["--ui-color-6"] }}
          >
            This is standard body typography rendered using the primary text
            token. You can test line-height, kerning, and readability. Important
            concepts can be{" "}
            <span
              ...
              style={{ color: roleMapping["--ui-color-1"] }}
            >
              highlighted in the brand primary
            </span>{" "}
            color or referenced in the{" "}
            <span
              className="font-bold"
              data-role="--ui-color-2"
              style={{ color: roleMapping["--ui-color-2"] }}
          ...
          >
            ...
            >
              "Color contrast is a cornerstone of accessibility. Choosing
              beautiful colors that developers can actually read creates
          ...
          >
            ...
            <code
              ...
              data-role="--ui-color-3"
              style={{
                backgroundColor: roleMapping["--ui-color-3"],
                color: roleMapping["--ui-color-2"],
              }}
            >
        ...
        >
          ...
          <div className="space-y-3">
            {tests.map((t, i) => {
              ...
              const ratio =
                textHex && bgHex ? getContrastRatio(textHex, bgHex) : 1;
              ...
              return (
                <div
                  ...
                  data-role="--ui-color-3"
                  style={{
                    backgroundColor: roleMapping["--ui-color-3"] + "22",
                    borderColor: roleMapping["--ui-color-5"],
                  }}
                >
                  <div className="min-w-0">
                    ...
                    <p
                      className="font-mono text-[9px] mt-0.5 opacity-80"
                      data-role="--ui-color-7"
                      style={{ color: roleMapping["--ui-color-7"] }}
                    >
                      {textHex} on {bgHex}
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full border text-[8px] font-black tracking-widest uppercase flex items-center gap-1 ${compliance.style}`}
                    >
