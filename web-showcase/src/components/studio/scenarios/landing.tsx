  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        ...
        <div
          className="hidden sm:flex items-center gap-6 text-xs font-bold"
      ...
      <div className="text-center max-w-2xl mx-auto space-y-6 py-6">
        ...
        <p
          ...
          style={{ color: roleMapping["--ui-color-7"] }}
        >
          Unlock your team's velocity with beautifully structured, accessible
          SCSS theme templates. Made for clean CSS properties and standard
          modular setups.
        </p>
