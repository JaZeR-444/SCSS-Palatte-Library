        ...
        >
          ...
          >
            ...
            <div className="p-3 bg-white/10 backdrop-blur-md border border-white/10 rounded-xl text-white">
              <span className="text-[8px] font-black uppercase tracking-widest text-white/60">New Arrival</span>
              <h5 className="font-bold text-xs mt-0.5">Atmosphere Active Jacket</h5>
            </div>
          </div>
                  ...
                  {sizes.map((size) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          backgroundColor: isSelected ? roleMapping["--ui-color-1"] : "transparent",
                          borderColor: isSelected ? roleMapping["--ui-color-1"] : roleMapping["--ui-color-5"],
                          color: isSelected ? roleMapping["--ui-color-4"] : roleMapping["--ui-color-6"]
                        }}
                      >
                        {size}
                      </button>
      ...
      <div className="lg:col-span-4 flex flex-col gap-4">
        ...
        >
          <div className="space-y-6">
            <div className="flex justify-between items-center pb-3 border-b" style={{ borderColor: roleMapping["--ui-color-5"] }}>
            ...
            {cartCount > 0 ? (
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div 
                    ...
                    style={{ background: `linear-gradient(135deg, ${roleMapping["--ui-color-1"]}, ${roleMapping["--ui-color-2"]})` }}
                  >
                    <ShoppingCart className="h-5 w-5" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-bold truncate" style={{ color: roleMapping["--ui-color-6"] }}>Jacket • {activeSize}</p>
                    <p className="text-[10px] font-bold" style={{ color: roleMapping["--ui-color-7"] }}>{cartCount}x • $129.00</p>
                  </div>
                  <button 
              ...
              <div className="py-12 text-center space-y-3">
                <ShoppingCart className="h-10 w-10 mx-auto opacity-30" style={{ color: roleMapping["--ui-color-7"] }} />
                <p className="text-xs font-semibold" style={{ color: roleMapping["--ui-color-7"] }}>Your cart is empty.</p>
              </div>
            )}
          </div>

          <div className="pt-6 border-t mt-6" style={{ borderColor: roleMapping["--ui-color-5"] }}>
            <div className="flex justify-between items-center mb-4">
              <span className="text-xs font-bold" style={{ color: roleMapping["--ui-color-7"] }}>Subtotal</span>
              <span className="text-sm font-black" style={{ color: roleMapping["--ui-color-6"] }}>
