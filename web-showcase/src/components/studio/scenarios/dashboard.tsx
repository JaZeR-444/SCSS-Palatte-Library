    ...
    <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        >
          ...
          {[Activity, Database, ShieldCheck].map((Icon, index) => (
            <div
              ...
              data-role={`--ui-color-${index + 3}`}
              style={{
                backgroundColor: roleMapping[`--ui-color-${index + 3}`],
                color: roleMapping["--ui-color-9"],
              }}
            >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${roleMapping["--ui-color-10"]}, ${roleMapping["--ui-color-12"]})`,
                  color: roleMapping["--ui-color-9"],
                }}
              >
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-1">
                    <div
                      ...
                      data-role={`--ui-color-${metric.role}`}
                      style={{
                        backgroundColor:
                          roleMapping[`--ui-color-${metric.role}`],
                      }}
                    />
                    <div
                      className="w-2 h-2 rounded-full animate-pulse"
                      data-role="--ui-color-21"
                      style={{ backgroundColor: roleMapping["--ui-color-21"] }}
                    />
                  </div>
                </div>
                <p
                ...
                <div className="h-2 w-full rounded-full bg-gray-100 dark:bg-slate-800 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${62 + i * 12}%`,
                      backgroundColor: roleMapping[`--ui-color-${metric.role}`],
                    }}
                  />
                </div>
              </div>
          ...
          <div className="grid grid-cols-8 gap-2 items-end h-20">
            {[42, 58, 51, 72, 66, 84, 76, 91].map((height, index) => (
              <div
                ...
                data-role={`--ui-color-${10 + (index % 6)}`}
                style={{
                  height: `${height}%`,
                  backgroundColor:
                    roleMapping[`--ui-color-${10 + (index % 6)}`],
                  opacity: 0.85,
                }}
              />
            ))}
      ...
      <div className="lg:col-span-3 flex flex-col justify-center gap-4">
        <div className="p-6 rounded-3xl bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100/50 dark:border-indigo-500/10">
          <h4 className="text-xs font-black uppercase text-indigo-500 mb-3 tracking-widest">
            Dashboard View
          </h4>
          <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
            Optimized for deep-surface navigation and high-contrast status
            monitoring.
          </p>
        </div>
      </div>
